function streamfunctionPlotting(gam, xyPanel, xyBoundVortex, xygFSVortex, alpha_rad, np)
   ...
   for i = 1:np
    ...
    if size(xygFSVortex) ~= 0
        ...
        plot(xygFSVortex(1:noVortices/2,1), xygFSVortex(1:noVortices/2,2),'-o');
        plot(xygFSVortex(noVortices/2+1:noVortices,1), xygFSVortex(noVortices/2+1:noVortices,2),'-o');
