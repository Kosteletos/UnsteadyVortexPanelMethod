function [NEWxygFSVortex] = biotSavart(dt, np, vel, alpha, alphaDot, xyPanel_rel, xyBoundVortex_rel, gam, xygFSVortex_rel)
...
xygFSVortex_rel = [xyPanel_rel(1,1) ,xyPanel_rel(1,2), gam(1) ; xygFSVortex_rel];
...
uvKinRot(:,2) = alphaDot*xygFSVortex_rel(:,1);
